...
export const articles = [
  ...
  },
  {
    ...
    content: `
      ...
      <div class="aspect-w-16 aspect-h-9 my-6">
        <iframe 
          src="https://www.youtube.com/embed/zI1kFTPWe9g" 
  ...
  {
    slug: "principios-inabalaveis",
    title: "A Importância de Princípios Inabaláveis",
    summary: "Por que Kirk acreditava que princípios firmes são essenciais em tempos de mudança.",
    content: `
      <p class="mb-4">Charlie Kirk era um defensor fervoroso da ideia de que, em um mundo em constante mudança, a adesão a princípios inabaláveis é mais crucial do que nunca. Ele argumentava que sem uma base sólida de valores e verdades atemporais, a sociedade se torna suscetível à deriva moral e à confusão ideológica.</p>

      <p class="mb-4">Para Kirk, esses princípios não eram meras convenções sociais, mas sim verdades fundamentais que sustentam a civilização ocidental, como a liberdade individual, a responsabilidade pessoal, a fé e a família. Ele via a defesa desses pilares como uma forma de resistência contra as forças que buscavam desmantelar as estruturas tradicionais e promover o relativismo.</p>

      <blockquote class="border-l-4 border-stars-blue pl-4 italic my-6">
        "Em tempos de incerteza, os princípios não são um luxo, mas uma bússola essencial."
      </blockquote>
  ...
  },
  {
    ...
    content: `
      ...
      <p class="mb-4">Mas havia algo mais profundo em jogo. Kirk não era apenas eficaz; ele era provocador. Seus eventos "Prove Me Wrong" — onde montava uma mesa em campi e desafiava estudantes a debater — geravam confrontos virais que expunham a intolerância e a superficialidade intelectual de muitos ativistas progressistas. Cada vídeo de um estudante gritando incoerentemente com Kirk, cada tentativa fracassada de "cancelá-lo", apenas aumentava sua influência.</p>

      <h2 class="text-2xl font-bold mt-8 mb-4 text-stars-blue">O Assassino</h2>
      <p class="mb-4">Tyler Robinson tinha 22 anos quando puxou o gatilho. Um jovem que, até dois anos antes do crime, era um estudante aparentemente comum. Suas redes sociais daquele período mostravam um jovem interessado em videogames, filosofia e música indie. Descrito por conhecidos como "quieto e reservado", nada em seu perfil inicial sugeria o terrorista em que se transformaria.</p>
      <p class="mb-4">A radicalização de Robinson seguiu um padrão que investigadores federais agora reconhecem como típico entre extremistas de esquerda universitários. Começou com a participação em grupos de leitura sobre teoria crítica. Progrediu para participação em protestos violentos. Culminou com discussões em fóruns online sobre táticas extremistas, incluindo conversas no Discord sobre como ocultar armas e planear ataques.</p>
      <p class="mb-4">A investigação sobre Robinson revelou evidências perturbadoras de planejamento meticuloso, embora os detalhes específicos dos materiais apreendidos ainda estejam sob análise das autoridades.</p>
      <p class="mb-4">As investigações federais sugerem que a radicalização de Robinson seguiu um padrão identificado em outros casos de extremismo universitário, com progressão gradual de grupos de discussão teórica para ação violenta.</p>
      ...
      <p class="mb-4">As balas encontradas na cena do crime contavam sua própria história. Cada projétil tinha inscrições meticulosamente gravadas: "ANTIFA", "NO FASCISTS", "BELLA CIAO" — a canção partisan italiana adotada como hino pela esquerda radical global. Não era apenas um assassinato; era uma declaração de guerra simbólica.</p>

      <h2 class="text-2xl font-bold mt-8 mb-4 text-stars-blue">O Momento</h2>
      ...
      <p class="mb-4">O atirador chegou ao campus às 11:52 da manhã, 31 minutos antes do ataque. Vestido como trabalhador de manutenção, carregando uma mochila com o rifle desmontado, Robinson subiu ao telhado do Losee Center sem despertar suspeitas. Montou a arma com calma profissional. Ajustou a mira telescópica. E esperou.</p>
      <p class="mb-4">Testemunhas relatam ter visto um homem no telhado minutos antes do disparo. Alguns até fotografaram. Uma estudante, Sarah Chen, postou no Instagram: "Tem um cara estranho no telhado do Losee. Será que é segurança?" O post, com timestamp de 12:19, quatro minutos antes do tiro, levanta questões perturbadoras sobre a resposta — ou falta dela — das autoridades.</p>
      ...
      <h2 class="text-2xl font-bold mt-8 mb-4 text-stars-blue">A Reação</h2>
      <p class="mb-4">Nos primeiros momentos após o tiro, o caos tomou conta do auditório. Estudantes corriam em pânico, alguns se jogavam ao chão, outros tentavam ajudar Kirk enquanto o sangue se espalhava pelo palco. O serviço de emergência foi acionado às 12:24. Kirk foi declarado morto às 12:41, antes mesmo de chegar ao hospital.</p>
      <p class="mb-4">Mas foi a reação nas horas e dias seguintes que revelou a profundidade da divisão moral na América contemporânea. Enquanto milhões lamentavam a perda de um pai, marido e líder político, segmentos perturbadores da esquerda radical celebravam abertamente.</p>
      <p class="mb-4">Um professor de Harvard postou no Twitter: "Um fascista a menos. O mundo está melhor hoje." Uma repórter da CNN escreveu: "Karma existe. Kirk colheu o que plantou." Uma deputada estadual democrata da Califórnia foi ainda mais explícita: "Que sirva de aviso para outros propagadores de ódio."</p>
      <p class="mb-4">As consequências foram rápidas e severas. Em 72 horas, mais de 500 pessoas haviam sido demitidas de seus empregos por celebrar o assassinato. Universidades abriram processos disciplinares contra dezenas de professores. Empresas da Fortune 500 emitiram declarações condenando funcionários que haviam comemorado a morte.</p>
      <p class="mb-4">No Brasil, a reação foi igualmente reveladora. Membros do PT foram flagrados em grupos de WhatsApp celebrando o assassinato. Gleisi Hoffmann postou e rapidamente deletou um tweet sugerindo que Kirk "provocou a própria morte". Líderes do MST organizaram o que descreveram em comunicações internas como um "churrasco de comemoração". Professores de universidades federais aplaudiram em sala de aula ao anunciar a notícia.</p>
      ...
      <h2 class="text-2xl font-bold mt-8 mb-4 text-stars-blue">A Viúva</h2>
      <p class="mb-4">Erika Kirk tinha 29 anos quando se tornou viúva. Mãe de três filhos — de 7, 5 e 2 anos — ela poderia ter escolhido o silêncio e o luto privado. Em vez disso, 48 horas após o assassinato do marido, ela subiu ao palco na sede do Turning Point USA em Phoenix e pronunciou palavras que ecoariam globalmente.</p>
      <p class="mb-4">"Os assassinos do meu marido acreditavam que estavam matando um movimento", disse Erika, a voz firme apesar das lágrimas. "Eles não entenderam que estavam criando um exército. Onde havia um Charlie Kirk, agora haverá cem mil."</p>
      <p class="mb-4">Os números confirmaram sua profecia. Nas 72 horas seguintes ao assassinato, o TPUSA registrou milhares de novos membros. As doações totalizaram mais de 3 milhões de dólares nas primeiras 48 horas. Dezenas de novos capítulos universitários foram estabelecidos.</p>
      <p class="mb-4">Mas havia algo mais profundo acontecendo. Erika revelou que Charlie havia previsto sua própria morte. "Três dias antes", ela contou, "Charlie me disse: 'Se algo acontecer comigo, não pare, eles querem nos silenciar através do medo, não deixe que vençam.'" Documentos posteriormente descobertos confirmaram que Kirk havia recebido 147 ameaças de morte críveis apenas em 2025, todas reportadas ao FBI, nenhuma investigada seriamente.</p>

      <h2 class="text-2xl font-bold mt-8 mb-4 text-stars-blue">As Conexões Brasileiras</h2>
      <p class="mb-4">A descoberta de conexões brasileiras no caso Kirk transformou o assassinato de uma tragédia americana em uma questão de segurança internacional. A lista de alvos encontrada com Robinson incluía proeminentes conservadores brasileiros, mas as conexões iam muito além.</p>
      <p class="mb-4">As investigações revelaram que Robinson consumia conteúdo extremista de várias fontes, incluindo fóruns internacionais onde o ódio contra figuras conservadoras era rotineiramente expressado.</p>
      <p class="mb-4">Embora não haja evidências diretas de coordenação operacional entre Robinson e grupos brasileiros, a similaridade ideológica é inegável. O mesmo ódio que motivou o ataque contra Kirk ecoa nas ameaças que conservadores brasileiros recebem diariamente, nas celebrações da esquerda radical quando são atacados, na impunidade que cerca a violência política.</p>
      <p class="mb-4">O paralelo com o Brasil é inevitável. Em 2018, Jair Bolsonaro sofreu um atentado durante a campanha presidencial, esfaqueado por Adélio Bispo. A mesma ideologia de ódio que motivou aquele ataque ecoa no assassinato de Kirk. Charlie Kirk havia se encontrado com Bolsonaro em eventos conservadores e criticado publicamente a perseguição judicial que o ex-presidente brasileiro enfrenta.</p>
      ...
      <p class="mb-4 text-sm text-muted-foreground">Após ameaças, Nikolas Ferreira pede reforço na segurança</p>
      <p class="mb-4">Kirk havia expressado preocupações sobre a segurança de líderes conservadores globalmente. Em seus últimos meses, recebeu 147 ameaças de morte críveis, todas reportadas ao FBI. Apesar dos riscos conhecidos, ele continuou seus eventos públicos, acreditando que recuar seria uma vitória para aqueles que queriam silenciá-lo.</p>

      <h2 class="text-2xl font-bold mt-8 mb-4 text-stars-blue">O Despertar</h2>
      <p class="mb-4">O martírio de Charlie Kirk — e não há outra palavra para descrever o que aconteceu — catalisou uma transformação no movimento conservador global que cientistas políticos ainda lutam para quantificar. O fenômeno foi além do crescimento numérico do TPUSA ou das manifestações massivas. Foi uma mudança qualitativa na consciência política de uma geração.</p>
      <p class="mb-4">O assassinato de Kirk e as reações a ele revelaram divisões profundas na sociedade americana (e brasileira) sobre violência política e os limites do discurso aceitável.</p>
      <p class="mb-4">O impacto do assassinato de Kirk nas tendências políticas da juventude americana ainda está sendo analisado por cientistas políticos. Mais significativo: 67% dos entrevistados disseram que o assassinato e as reações a ele foram "extremamente" ou "muito" importantes em sua mudança de perspectiva política.</p>
      <p class="mb-4">No Brasil, o assassinato de Kirk gerou reações diversas, com grupos conservadores expressando solidariedade e preocupação com a escalada da violência política. Movimentos estudantis conservadores, antes marginalizados em universidades federais, começaram a atrair multidões.</p>
      <p class="mb-4">Houve mudanças notáveis no ambiente corporativo, com várias empresas reavaliando suas políticas após funcionários celebrarem o assassinato publicamente. Algumas empresas começaram a reavaliar suas políticas após o assassinato.</p>

      <h2 class="text-2xl font-bold mt-8 mb-4 text-stars-blue">As Consequências Legais</h2>
      <p class="mb-4">Tyler Robinson foi preso 33 horas após o assassinato, entregue pela própria mãe, que descobriu o arsenal e os planos do filho. "Eu criei um menino doce", ela disse aos investigadores, soluçando. "A universidade me devolveu um monstro."</p>
      <p class="mb-4">O julgamento de Robinson promete ser o caso criminal mais observado desde O.J. Simpson. A promotoria busca a pena de morte sob acusações de terrorismo doméstico, a primeira vez que tal classificação é aplicada a um membro do Antifa. A defesa argumenta diminuição de responsabilidade por "doutrinação ideológica extrema".</p>
      <p class="mb-4">Mas Robinson é apenas a ponta do iceberg. Investigações federais continuam em andamento para identificar possíveis cúmplices. O debate sobre a classificação de grupos extremistas como organizações terroristas foi reacendido após o assassinato. Legislação conhecida como "Charlie Kirk Act" está em tramitação no Congresso americano, propondo proteção federal para palestrantes políticos e penas severas para violência politicamente motivada.</p>
      ...
      <h2 class="text-2xl font-bold mt-8 mb-4 text-stars-blue">O Legado</h2>
      <p class="mb-4">O Turning Point USA, agora liderado por Erika Kirk em parceria com um conselho de líderes conservadores, continua expandindo sua influência entre jovens conservadores. O "Charlie Kirk Show" continua no ar, apresentado rotativamente por figuras conservadoras proeminentes, alcançando audiências recordes.</p>
      <p class="mb-4">As eleições de metade do mandato (midterm) americanas de 2026 são vistas por analistas como um teste crucial para o movimento conservador pós-Kirk. O impacto do assassinato na mobilização de jovens conservadores ainda está sendo medido.</p>
      <p class="mb-4">Mas o verdadeiro legado de Kirk pode ser mais profundo que vitórias eleitorais. Sua morte forçou uma sociedade a confrontar uma verdade desconfortável: que a violência política, racionalizada e romantizada por décadas de retórica radical, tem consequências reais. Que quando se desumaniza o oponente político, o assassinato se torna não apenas possível, mas inevitável.</p>
      <p class="mb-4">"Charlie sempre disse que a batalha real não era entre esquerda e direita", lembra Erika Kirk. "Era entre os que acreditavam no debate e os que abraçavam a violência. Entre os que veem o outro lado como adversários e os que os veem como inimigos a serem eliminados."</p>

      <h2 class="text-2xl font-bold mt-8 mb-4 text-stars-blue">Epílogo: O Último Debate</h2>
      <p class="mb-4">Há uma ironia mórbida no fato de que Charlie Kirk morreu no meio de uma frase sobre como a esquerda havia abraçado a violência por ter perdido o debate das ideias. Sua morte provou seu ponto de forma mais eloquente do que qualquer argumento poderia.</p>
      <p class="mb-4">Mas há também uma lição mais profunda aqui, uma que transcende linhas partidárias. Quando uma sociedade permite que o ódio político se transforme em violência celebrada, quando professores universitários aplaudem assassinatos em sala de aula, quando jornalistas racionalizam o terrorismo, quando políticos eleitos justificam o injustificável — essa sociedade está à beira do abismo.</p>
      ...
      <p class="mb-4">O que sabemos com certeza é isto: no dia 10 de setembro de 2025, às 12:23, um jovem pai de três filhos foi executado por suas ideias políticas. Nos dias que se seguiram, milhões decidiram que isso era inaceitável. E nessa decisão coletiva, nesse despertar moral, reside talvez a única esperança de que Charlie Kirk não tenha morrido em vão.</p>
      <p class="mb-4">Como ele próprio escreveu em seu último tweet, postado na manhã de sua morte: "A verdade não morre com o mensageiro. Ela se multiplica nos corações daqueles que a ouvem."</p>
      <p class="mb-4">Palavras proféticas de um homem que não viveu para ver sua profecia se realizar.</p>
      <hr class="my-8 border-t border-gray-300"/>
      <p class="text-sm text-muted-foreground mb-4"><em>Esta investigação foi baseada em mais de 170 fontes, incluindo documentos oficiais, entrevistas exclusivas, registros judiciais e análises de especialistas. Todas as informações foram verificadas por pelo menos duas fontes independentes.</em></p>
      <p class="text-sm text-muted-foreground">Fonte: <a href="https://www.oeditorial.co/p/como-o-assassinato-de-charlie-kirk" target="_blank" rel="noopener noreferrer" class="text-blue-500 hover:underline">https://www.oeditorial.co/p/como-o-assassinato-de-charlie-kirk</a></p>
    `,
  },
  {
    ...
    content: `
      ...
      <ul>
        <li><strong>Viúva Erika Kirk</strong>: Em um endereço lacrimoso, agradeceu aos primeiros socorros e pediu que o legado de Kirk inspire unidade.</li>
        <li><strong>Medalha Presidencial da Liberdade Póstuma</strong>: O presidente Donald Trump concedeu a honraria a Kirk, reconhecendo sua influência no movimento conservador. Essa distinção foi uma das primeiras reações oficiais, destacando seu papel na mobilização da juventude.</li>
...
export const tributes = [
  {
    ...
    "declaração": "O Grande, e até mesmo Lendário, Charlie Kirk está morto. Ninguém compreendia ou tinha o Coração da Juventude dos Estados Unidos da América melhor do que Charlie. Ele era amado e admirado por TODOS, especialmente por mim, e agora não está mais entre nós. Melania e meus pêsames vão para sua linda esposa Erika e sua família. Charlie, nós te amamos!"
  },
  {
    "nome": "Javier Milei",
    "nação": "Argentina",
    "declaração": "Minhas condolências à família de Charlie Kirk e a todos os jovens do mundo que o admiravam e o ouviam. Um formidável divulgador das ideias de liberdade e um firme defensor do Ocidente. Ele foi vítima de um assassinato atroz em meio a uma onda de violência política de esquerda por toda a região. A esquerda é sempre, em todos os momentos e em todos os lugares, um fenômeno violento cheio de ódio. O mundo inteiro perdeu um ser humano incrível. Adeus."
  },
  {
    "nome": "Giorgia Meloni",
    "nação": "Itália",
    "declaração": "A notícia do assassinato de Charlie Kirk, jovem e seguido ativista republicano, é chocante. Um homicídio atroz, uma ferida profunda para a democracia e para quem acredita na liberdade. Minhas condolências à sua família, aos seus entes queridos e à comunidade conservadora americana. É hora de denunciar esse clima de ódio insustentável."
  },
  {
    "nome": "Benjamin Netanyahu",
    "nação": "Israel",
    "declaração": "Charlie Kirk foi assassinado por falar a verdade e defender a liberdade. Um amigo fervoroso de Israel, ele combateu as mentiras e defendeu a civilização judaico-cristã. Falei com ele há apenas duas semanas e o convidei para ir a Israel. Infelizmente, essa visita não acontecerá. Perdemos um ser humano incrível. Seu orgulho sem limites pela América e sua crença valente na liberdade de expressão deixarão um impacto duradouro. Descanse em paz, Charlie Kirk."
  },
  {
    "nome": "Viktor Orbán",
    "nação": "Hungria",
    "declaração": "A morte de Charlie Kirk é resultado da campanha internacional de ódio promovida pela esquerda progressista-liberal. Ele foi um grande defensor da liberdade e dos valores conservadores, e sua perda é uma tragédia para o mundo livre."
  },
  {
    "nome": "Keir Starmer",
    "nação": "Reino Unido",
    "declaração": "Todos devemos ser livres para debater abertamente e livremente sem medo – não há justificativa para a violência política. Nossas condolências à família de Charlie Kirk e à comunidade afetada."
  },
  {
    "nome": "Boris Johnson",
    "nação": "Reino Unido",
    "declaração": "Charlie Kirk era uma voz corajosa pela liberdade. Sua morte é uma perda trágica para o movimento conservador global e um lembrete do perigo da violência política."
  },
  {
    "nome": "Santiago Abascal",
    "nação": "Espanha",
    "declaração": "Charlie Kirk, mártir da liberdade, foi vítima da esquerda violenta. Sua luta pela verdade e pelos valores ocidentais continuará inspirando gerações. Descanse em paz, amigo."
  },
  {
    "nome": "Nigel Farage",
    "nação": "Reino Unido",
    "declaração": "Charlie Kirk era um amigo e um guerreiro pela verdade. Sua morte é simbólica de um tempo sombrio, mas seu legado pela liberdade de expressão perdurará."
  },
  {
    "nome": "Elon Musk",
    "nação": "Estados Unidos",
    "declaração": "Charlie Kirk era uma voz pela liberdade. Sua morte é uma tragédia, e condeno as mensagens de ódio que circularam após o crime. Seu legado viverá."
  },
  {
    "nome": "Erika Kirk",
    "nação": "Estados Unidos",
    "declaração": "Em memória de Charlie, um patriota destemido e homem de fé inabalável que dedicou sua vida à América. É maior que você, lembre-se disso... É maior que eu. Você está aqui para tornar a vida de outra pessoa melhor, a busca pela liberdade."
  },
  {
    "nome": "Pietro Parolin",
    "nação": "Vaticano",
    "declaração": "A posição do Vaticano é que somos contra todos os tipos de violência. Devemos ser muito tolerantes e respeitosos com os outros, com suas ideias e convicções. Se não formos tolerantes e respeitosos, e formos violentos, essa não é a maneira de construir um mundo melhor."
  },
  {
    "nome": "Lauren Boebert",
    "nação": "Estados Unidos",
    "declaração": "Charlie Kirk era um guerreiro pela liberdade. Sua morte nos motiva a continuar sua luta. Oramos pela família e pela nação."
  },
  {
    "nome": "Elise Stefanik",
    "nação": "Estados Unidos",
    "declaração": "A morte de Charlie Kirk é resultado de falhas em políticas de segurança. Ele era um líder inspirador para a juventude conservadora. Descanse em paz."
  },
  {
    "nome": "George Simion",
    "nação": "Romênia",
    "declaração": "Charlie Kirk, defensor da Europa cristã e da liberdade, foi uma inspiração global. Sua perda é sentida em toda a direita europeia. Solidariedade à família."
  },
  {
    "nome": "Ron DeSantis",
    "nação": "Estados Unidos",
    "declaração": "Charlie Kirk foi um campeão da liberdade e da juventude conservadora. Sua morte é uma perda irreparável. Que seu legado inspire todos nós a lutar pela verdade."
  },
  {
    "nome": "Ted Cruz",
    "nação": "Estados Unidos",
    "declaração": "Charlie Kirk dedicou sua vida à defesa dos valores americanos. Oramos pela família e condenamos veementemente essa violência política."
  },
  {
    "nome": "Matt Gaetz",
    "nação": "Estados Unidos",
    "declaração": "Charlie Kirk era um patriota incansável. Sua voz pela liberdade ecoará para sempre. Descanse em paz, irmão."
  },
  {
    "nome": "Vivek Ramaswamy",
    "nação": "Estados Unidos",
    "declaração": "Charlie Kirk inspirou uma geração a lutar pela América. Sua morte nos lembra o custo da liberdade. Honraremos seu legado."
  },
  {
    "nome": "Tucker Carlson",
    "nação": "Estados Unidos",
    "declaração": "Charlie Kirk era um amigo e um guerreiro pela verdade. O mundo é mais pobre sem ele. Que Deus abençoe sua família."
  },
  {
    "nome": "Candace Owens",
    "nação": "Estados Unidos",
    "declaração": "Charlie Kirk mudou vidas, incluindo a minha. Sua coragem era inigualável. Descanse em paz, Charlie."
  },
  {
    "nome": "Ben Shapiro",
    "nação": "Estados Unidos",
    "declaração": "Charlie Kirk foi um pilar do conservadorismo jovem. Sua perda é devastadora. Continuaremos sua luta."
  },
  {
    "nome": "Jordan Peterson",
    "nação": "Canadá",
    "declaração": "Charlie Kirk defendia princípios eternos com paixão. Sua morte é uma tragédia para a liberdade de expressão."
  },
  {
    "nome": "Pierre Poilievre",
    "nação": "Canadá",
    "declaração": "Charlie Kirk inspirou jovens ao redor do mundo. Condolências à família e à nação americana."
  },
  {
    "nome": "Marine Le Pen",
    "nação": "França",
    "declaração": "Charlie Kirk era um defensor da civilização ocidental. Sua morte nos alerta para os perigos do extremismo."
  },
  {
    "nome": "Éric Zemmour",
    "nação": "França",
    "declaração": "Charlie Kirk lutou pela verdade contra o politicamente correto. Honra eterna a ele."
  },
  {
    "nome": "Alice Weidel",
    "nação": "Alemanha",
    "declaração": "Charlie Kirk representava os valores conservadores que precisamos defender. Descanse em paz."
  },
  {
    "nome": "Geert Wilders",
    "nação": "Países Baixos",
    "declaração": "Charlie Kirk era um aliado na luta pela liberdade. Sua perda é sentida globalmente."
  },
  {
    "nome": "Matteo Salvini",
    "nação": "Itália",
    "declaração": "Charlie Kirk defendia a família e a pátria. Oramos por sua família e condenamos a violência."
  },
  {
    "nome": "Jair Bolsonaro",
    "nação": "Brasil",
    "declaração": "Charlie Kirk era um grande amigo do Brasil e da liberdade. Sua morte nos entristece profundamente. Descanse em paz."
  },
  {
    "nome": "Eduardo Bolsonaro",
    "nação": "Brasil",
    "declaração": "Charlie Kirk inspirou gerações pela liberdade. Honraremos seu legado no Brasil e no mundo."
  },
  {
    "nome": "Nayib Bukele",
    "nação": "El Salvador",
    "declaração": "Charlie Kirk lutou pela verdade e contra o socialismo. Sua coragem era admirável. Condolências à família."
  }
];