  ...
  return (
    <div className="container mx-auto max-w-2xl py-12 px-4">
      ...
      <p className="text-center text-lg text-muted-foreground mb-12">
        Tem alguma pergunta, sugestão ou gostaria de compartilhar uma citação favorita? Clique no botão abaixo para abrir o formulário e nos enviar uma mensagem.
      </p>
