    ...
    <div className="container mx-auto max-w-4xl py-12 px-4">
      ...
      <div className="relative">
        ...
        {timelineEvents.map((event, index) => (
          <div key={index} className="mb-8 flex justify-between items-center w-full" onClick={() => toggleEvent(index)} style={{ cursor: 'pointer' }}>
            ...
            <div className="z-10 flex items-center justify-center order-2 bg-background">
